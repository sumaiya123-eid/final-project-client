        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {trainers
            ...
            .map((trainer) => (
              <div
              key={trainer._id}
              className="bg-white shadow-xl rounded-lg p-4 flex flex-col items-start text-left transition-all transform hover:scale-105 hover:shadow-2xl hover:translate-y-2"
            >
              ...
              <div className="mt-4 space-y-2">
                <h2 className="text-xl font-semibold flex items-center gap-2 justify-start text-gray-800">
                  <FaUserAlt className="text-blue-500" /> {trainer.fullName}
                </h2>
                <p className="text-gray-600 text-base flex items-center gap-2">
                  <FaBirthdayCake className="text-red-500" /> <p className="text-black font-bold">Age :</p>{" "}
                  {trainer.age || "N/A"}
                </p>
                <p className="text-gray-600 text-base flex items-center gap-2">
                  <FaEnvelope className="text-green-500" /> <p className="text-black font-bold">Email :</p> {trainer.email}
                </p>
                <p className="text-gray-600 text-base flex items-center gap-2">
                  <FaClock className="text-purple-500" /> <p className="text-black font-bold">Available Time :</p>{" "}
                  {trainer.availableTime || "Not specified"}
                </p>
                <p className="text-gray-600 text-base flex items-center gap-2">
                  <FaToolbox className="text-orange-500" /> <p className="text-black font-bold">Experience :</p>{" "}
                ...
                <div className="mb-4">
                  <h3 className="text-base font-semibold flex items-center gap-2 text-gray-700">
                    <FaStar className="text-yellow-500" /> <p className="text-black font-bold">Skills :</p>
                  </h3>
                ...
                <div className="mb-4">
                  <h3 className="text-base font-semibold flex items-center gap-2 text-gray-700">
                    <FaListAlt className="text-green-500" /> <p className="text-black font-bold">Classes :</p>
                  </h3>
                  <p className="text-gray-600 text-base">
              ...
              <div className="flex justify-start mt-4">
                <button
                  className="px-4 py-2 bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-md shadow-md hover:from-green-500 hover:to-blue-600 transition-all duration-300 transform hover:scale-105"
