            ...
            >
              ...
              <div className="mt-4 space-y-2">
                <h2 className="text-xl font-semibold flex items-center gap-2 justify-start text-yellow-500">
                  ...
                  <p className="text-white font-bold">Trainer Name :</p>{trainer.fullName}
                </h2>
                <p className="text-yellow-500 text-base flex items-center gap-2">
                  <FaBirthdayCake className="text-red-500" /> <p className="text-white font-bold">Age :</p>{" "}
                  {trainer.age || "N/A"}
                </p>
                <p className="text-yellow-500 text-base flex items-center gap-2">
                  <FaEnvelope className="text-green-500" /> <p className="text-white font-bold">Email :</p> {trainer.email}
                </p>
                <p className="text-yellow-500 text-base flex items-center gap-2">
                  <FaClock className="text-purple-500" /> <p className="text-white font-bold">Available Time :</p>{" "}
                  {trainer.availableTime || "Not specified"}
                </p>
                <p className="text-yellow-500 text-base flex items-center gap-2">
                  <FaToolbox className="text-orange-500" /> <p className="text-white font-bold">Experience :</p>{" "}
                 ...
                 <div className="mb-4">
                  <h3 className="text-base font-semibold flex items-center gap-2 text-yellow-500">
                    <FaStar className="text-yellow-500" /> <p className="text-white font-bold">Available Slots :</p>
                  </h3>
                ...
                <div className="mb-4">
                  <h3 className="text-base font-semibold flex items-center gap-2 text-yellow-500">
                    <FaStar className="text-yellow-500" /> <p className="text-white font-bold">Skills :</p>
                  </h3>
                  <p className="text-yellow-500 text-base">
                ...
                <div className="mb-4">
                  <h3 className="text-base font-semibold flex items-center gap-2 text-yellow-500">
                    <FaListAlt className="text-green-500" /> <p className="text-white font-bold">Classes :</p>
                  </h3>
                  <p className="text-yellow-500 text-base">
